...
export default function AboutPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="relative bg-gradient-to-br from-amber-50 via-yellow-50 to-amber-100 py-16 sm:py-20 md:py-24 px-4 sm:px-6 overflow-hidden">
                {/* Islamic geometric pattern */}
                <div className="absolute inset-0 opacity-5">
                    <div className="absolute inset-0" style={{
                        backgroundImage: `repeating-linear-gradient(45deg, transparent, transparent 30px, rgba(251, 191, 36, 0.3) 30px, rgba(251, 191, 36, 0.3) 60px),
                                        repeating-linear-gradient(-45deg, transparent, transparent 30px, rgba(251, 191, 36, 0.3) 30px, rgba(251, 191, 36, 0.3) 60px)`
                    }}></div>
                </div>

                <div className="max-w-4xl mx-auto text-center relative z-10">
                    <div className="inline-flex items-center gap-2 mb-4 sm:mb-6 px-4 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-amber-100 to-yellow-100 border-2 border-amber-200 rounded-full">
                        <Sparkles className="w-4 h-4 text-amber-700" />
                        <span className="text-amber-800 text-sm sm:text-base font-black uppercase tracking-wider">Our Story</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-4 sm:mb-6 px-2 leading-tight">
                        Your Trusted Partner for{' '}
                        <span className="block mt-2 bg-gradient-to-r from-amber-600 via-yellow-600 to-amber-700 bg-clip-text text-transparent">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 md:gap-8">
                    <div className="group p-7 sm:p-8 bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-2xl hover:shadow-2xl transition-all transform hover:-translate-y-2 hover:border-amber-300">
                        <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-amber-500 to-yellow-600 rounded-xl flex items-center justify-center mb-4 sm:mb-5 shadow-lg group-hover:scale-110 transition-transform">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-12 sm:py-16 md:py-20 px-4 sm:px-6 my-8 sm:my-12 overflow-hidden">
                {/* Islamic geometric pattern */}
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
                        <div className="text-white bg-white/10 backdrop-blur-sm border border-amber-400/20 rounded-3xl p-8 hover:bg-white/15 transition-all">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
                <div className="text-center mb-12 sm:mb-16">
                    <div className="inline-flex items-center gap-2 bg-amber-100 px-4 py-2 rounded-full mb-4">
                        ...
                        <span className="text-amber-800 text-sm font-bold uppercase tracking-wider">Benefits</span>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                    <div className="flex gap-4 sm:gap-5 p-6 sm:p-7 bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-2xl hover:shadow-xl transition-all hover:border-amber-300">
                        <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-amber-500 to-yellow-600 flex items-center justify-center shadow-lg">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 py-12 sm:py-16 md:py-20 px-4 sm:px-6 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                        <div className="bg-white/5 backdrop-blur-sm border border-amber-400/10 rounded-2xl p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-5xl sm:text-6xl font-black bg-gradient-to-r from-amber-400 to-yellow-500 bg-clip-text text-transparent mb-3">500+</h3>
                            <p className="text-base sm:text-lg text-gray-300 font-bold uppercase tracking-wider">Products & Guides</p>
                        </div>
                        <div className="bg-white/5 backdrop-blur-sm border border-amber-400/10 rounded-2xl p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-5xl sm:text-6xl font-black bg-gradient-to-r from-amber-400 to-yellow-500 bg-clip-text text-transparent mb-3">100K+</h3>
                            <p className="text-base sm:text-lg text-gray-300 font-bold uppercase tracking-wider">Satisfied Pilgrims</p>
                        </div>
                        <div className="bg-white/5 backdrop-blur-sm border border-amber-400/10 rounded-2xl p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-5xl sm:text-6xl font-black bg-gradient-to-r from-amber-400 to-yellow-500 bg-clip-text text-transparent mb-3">4.9★</h3>
                            <p className="text-base sm:text-lg text-gray-300 font-bold uppercase tracking-wider">Customer Rating</p>
                        </div>
                        <div className="bg-white/5 backdrop-blur-sm border border-amber-400/10 rounded-2xl p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-5xl sm:text-6xl font-black bg-gradient-to-r from-amber-400 to-yellow-500 bg-clip-text text-transparent mb-3">50+</h3>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
                <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-10 sm:p-12 md:p-16 text-center text-white shadow-2xl overflow-hidden">
                    {/* Islamic geometric pattern */}
                    <div className="absolute inset-0 opacity-10">
                        <div className="absolute inset-0" style={{
                            backgroundImage: `repeating-linear-gradient(45deg, transparent, transparent 20px, rgba(251, 191, 36, 0.1) 20px, rgba(251, 191, 36, 0.1) 40px),
                    ...
                    <div className="relative z-10">
                        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-amber-400/30">
                            <BookOpen className="w-4 h-4 text-amber-400" />
                            <span className="text-amber-300 text-sm font-bold uppercase tracking-wider">Begin Your Journey</span>
                        </div>
                        <h2 className="text-4xl sm:text-5xl font-black mb-4 sm:mb-5">Ready for Your Umrah?</h2>
                        <p className="text-lg sm:text-xl text-amber-100 mb-8 sm:mb-10 max-w-2xl mx-auto px-2 font-medium">
                            Explore our authentic Islamic products and comprehensive guides to prepare for your blessed pilgrimage
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link
                                to="/products"
                                className="inline-flex items-center justify-center gap-3 px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white rounded-full font-black text-lg sm:text-xl hover:shadow-2xl transform hover:scale-105 transition-all"
                            >
            ...
            <div className="bg-gradient-to-br from-amber-50 to-yellow-50 py-12 sm:py-16 md:py-20 px-4 sm:px-6">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-10 sm:mb-12">
                        <div className="inline-flex items-center gap-2 bg-white border-2 border-amber-200 px-4 py-2 rounded-full mb-4">
                            ...
                            <span className="text-amber-800 text-sm font-bold uppercase tracking-wider">Contact Us</span>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6">
                        <div className="p-7 sm:p-8 bg-white rounded-2xl shadow-lg border-2 border-amber-200 hover:shadow-xl transition-all hover:border-amber-300 text-center">
                            <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-yellow-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                                <Mail className="w-7 h-7 text-white" />
                            </div>
                            <h4 className="font-black text-base sm:text-lg text-gray-900 mb-2">Email Us</h4>
                            <p className="text-sm sm:text-base text-amber-700 font-bold break-all">{companyEmail}</p>
                        </div>
